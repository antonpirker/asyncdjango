...
echo "postgres12.wdpr.run:5432:antonpirker:antonpirker:e44ccd99e65b71bbaf13913e85e9063463fab1d3fd122d58692dc02dcede" >> ~/.pgpass

psql "postgres://wdprcustomeradm:AqsI]IBvS[you[zK8z^=mOb-+gQ1$p<s}9=ku}@customers-postgres-12.c0ivpkyb3o26.eu-central-1.rds.amazonaws.com:5432/postgres" -c "select * from information_schema.schemata;"
